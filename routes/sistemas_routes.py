from flask import Blueprint, request, jsonify, send_file, session, render_template, redirect, url_for, send_from_directory
...
HISTORIAL_PATH = os.path.join("static", "sistemas", "historial")
