...
sistemas_profesores = db['profesores']
...
def get_all_profesores():
    all_profesores = list(sistemas_profesores.find({
        "$or": [
            {"carrera1": "SISTEMAS COMPUTACIONALES"}, {"carrera2": "SISTEMAS COMPUTACIONALES"}, {"carrera3": "SISTEMAS COMPUTACIONALES"},
            {"carrera4": "SISTEMAS COMPUTACIONALES"}, {"carrera5": "SISTEMAS COMPUTACIONALES"}, {"carrera6": "SISTEMAS COMPUTACIONALES"},
            {"carrera7": "SISTEMAS COMPUTACIONALES"}, {"carrera8": "SISTEMAS COMPUTACIONALES"},
            {"carreraE1": "SISTEMAS COMPUTACIONALES"}, {"carreraE2": "SISTEMAS COMPUTACIONALES"}, {"carreraE3": "SISTEMAS COMPUTACIONALES"},
            {"carreraE4": "SISTEMAS COMPUTACIONALES"}, {"carreraE5": "SISTEMAS COMPUTACIONALES"}, {"carreraE6": "SISTEMAS COMPUTACIONALES"},
            {"carreraE7": "SISTEMAS COMPUTACIONALES"}, {"carreraE8": "SISTEMAS COMPUTACIONALES"},
            {"carreraC": "SISTEMAS COMPUTACIONALES"}
        ]
    }).sort("nombre", 1))
...
def historial_exportaciones():
    ...
    files = list(db.fs.files.find(
        {"filename": {"$regex": "^Datos_Sistemas_"}},
        {"filename": 1, "uploadDate": 1}
    ).sort("uploadDate", -1))  # Orden descendente por fecha
    return render_template("sistemas/historial.html", files=files)

@sistemas_bp.route('/historial/download/<filename>')
@login_required('Sistemas')
def download_file(filename):
    """Permite descargar los archivos almacenados en GridFS correspondientes a Sistemas Computacionales."""
...
# 📌 Ruta para eliminar archivos de GridFS en SISTEMAS
@sistemas_bp.route('/historial/delete/<filename>', methods=['DELETE'])
@login_required('Sistemas')
...
def export_data_auto():
    ...
    # 📌 Nombre del archivo
    filename = f"Datos_Sistemas_{current_year}-{period}.xlsx"
    ...
    cursor = collection.find({
        "$or": [
            {"carrera1": "SISTEMAS COMPUTACIONALES"}, {"carrera2": "SISTEMAS COMPUTACIONALES"},
            {"carrera3": "SISTEMAS COMPUTACIONALES"}, {"carrera4": "SISTEMAS COMPUTACIONALES"},
            {"carrera5": "SISTEMAS COMPUTACIONALES"}, {"carrera6": "SISTEMAS COMPUTACIONALES"},
            {"carrera7": "SISTEMAS COMPUTACIONALES"}, {"carrera8": "SISTEMAS COMPUTACIONALES"},
            {"carreraE1": "SISTEMAS COMPUTACIONALES"}, {"carreraE2": "SISTEMAS COMPUTACIONALES"},
            {"carreraE3": "SISTEMAS COMPUTACIONALES"}, {"carreraE4": "SISTEMAS COMPUTACIONALES"},
            {"carreraE5": "SISTEMAS COMPUTACIONALES"}, {"carreraE6": "SISTEMAS COMPUTACIONALES"},
            {"carreraE7": "SISTEMAS COMPUTACIONALES"}, {"carreraE8": "SISTEMAS COMPUTACIONALES"},
            {"carreraC": "SISTEMAS COMPUTACIONALES"}
        ]
    })
...
@sistemas_bp.route("/exportar-manual", methods=["POST"])
@login_required("Sistemas")
def exportar_manual():
    export_data_auto()
...
def export_selected():
    ...
    selected_profesores = [sistemas_profesores.find_one({'_id': ObjectId(profesor_id),
        "$or": [
            {"carrera1": "SISTEMAS COMPUTACIONALES"}, {"carrera2": "SISTEMAS COMPUTACIONALES"}, {"carrera3": "SISTEMAS COMPUTACIONALES"},
            {"carrera4": "SISTEMAS COMPUTACIONALES"}, {"carrera5": "SISTEMAS COMPUTACIONALES"}, {"carrera6": "SISTEMAS COMPUTACIONALES"},
            {"carrera7": "SISTEMAS COMPUTACIONALES"}, {"carrera8": "SISTEMAS COMPUTACIONALES"},
