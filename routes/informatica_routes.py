...
informatica_profesores = db['profesores']
...
def get_all_profesores():
    all_profesores = list(informatica_profesores.find({
        "$or": [
            {"carrera1": "INFORMÁTICA"}, {"carrera2": "INFORMÁTICA"}, {"carrera3": "INFORMÁTICA"},
            {"carrera4": "INFORMÁTICA"}, {"carrera5": "INFORMÁTICA"}, {"carrera6": "INFORMÁTICA"},
            {"carrera7": "INFORMÁTICA"}, {"carrera8": "INFORMÁTICA"},
            {"carreraE1": "INFORMÁTICA"}, {"carreraE2": "INFORMÁTICA"}, {"carreraE3": "INFORMÁTICA"},
            {"carreraE4": "INFORMÁTICA"}, {"carreraE5": "INFORMÁTICA"}, {"carreraE6": "INFORMÁTICA"},
            {"carreraE7": "INFORMÁTICA"}, {"carreraE8": "INFORMÁTICA"},
            {"carreraC": "INFORMÁTICA"}
        ]
    }).sort("nombre", 1))
...
@informatica_bp.route('/historial')
@login_required('Informatica')
def historial_exportaciones():
    ...
    files = list(db.fs.files.find(
        {"filename": {"$regex": "^Datos_Informatica_"}},
        {"filename": 1, "uploadDate": 1}
    ).sort("uploadDate", -1))  # Orden descendente por fecha
    return render_template("informatica/historial.html", files=files)

@informatica_bp.route('/historial/download/<filename>')
@login_required('Informatica')
...
# 📌 Ruta para eliminar archivos de GridFS en INFORMATICA
@informatica_bp.route('/historial/delete/<filename>', methods=['DELETE'])
@login_required('Informatica')
def delete_file(filename):
    """Elimina un archivo de GridFS correspondiente"""
    try:
...
def export_data_auto():
    """Ejecuta la exportación automática el 10 de junio, 25 de octubre y 1 de marzo."""
    ...
    cursor = collection.find({
        "$or": [
            {"carrera1": "INFORMÁTICA"}, {"carrera2": "INFORMÁTICA"},
            {"carrera3": "INFORMÁTICA"}, {"carrera4": "INFORMÁTICA"},
            {"carrera5": "INFORMÁTICA"}, {"carrera6": "INFORMÁTICA"},
            {"carrera7": "INFORMÁTICA"}, {"carrera8": "INFORMÁTICA"},
            {"carreraE1": "INFORMÁTICA"}, {"carreraE2": "INFORMÁTICA"},
            {"carreraE3": "INFORMÁTICA"}, {"carreraE4": "INFORMÁTICA"},
            {"carreraE5": "INFORMÁTICA"}, {"carreraE6": "INFORMÁTICA"},
            {"carreraE7": "INFORMÁTICA"}, {"carreraE8": "INFORMÁTICA"},
            {"carreraC": "INFORMÁTICA"}
        ]
    })
...
@informatica_bp.route("/exportar-manual", methods=["POST"])
@login_required("Informatica")
def exportar_manual():
    export_data_auto()
...
def export_selected():
    ...
    selected_profesores = [informatica_profesores.find_one({'_id': ObjectId(profesor_id),
        "$or": [
            {"carrera1": "INFORMÁTICA"}, {"carrera2": "INFORMÁTICA"}, {"carrera3": "INFORMÁTICA"},
            {"carrera4": "INFORMÁTICA"}, {"carrera5": "INFORMÁTICA"}, {"carrera6": "INFORMÁTICA"},
            {"carrera7": "INFORMÁTICA"}, {"carrera8": "INFORMÁTICA"},
    ...
    encargado = administrativos.find_one({'cargo': {'$in': ["ENCARGADA DEL DESPACHO DE DIRECCIÓN ACADÉMICA", "ENCARGADO DEL DESPACHO DE DIRECCIÓN ACADÉMICA", "DIRECTOR ACADÉMICO", "DIRECTORA ACADÉMICA"]}})
    ...
    for i, profesor in enumerate(selected_profesores):
        ...
        header_image_copy = Image("static/informatica/src/Encabezado1.PNG")
        footer_image_copy = Image("static/informatica/src/PieDePagina1.PNG")
