...
administrativos = db['electronica_administrativos']
...
def export_data():
    ...
    # Verificar si la colección pertenece a Ingeniería en Electrónica
    collection_mapping = {
        "profesores": electronica_profesores,
        "asignaturas": electronica_asignaturas,
        "asignaturasE": electronica_asignaturasE
    }
...
# Rutas para obtener las columnas de cada colección en Ingeniería en Electrónica
...
def export_selected():
    ...
    # Cargar imágenes
    header_image = Image("static/electronica/src/Encabezado1.PNG")
    footer_image = Image("static/electronica/src/PieDePagina1.PNG")
...
# Función para convertir Excel a PDF usando win32com en Electrónica
def excel_to_pdf_electronica(input_excel_path, output_pdf_path):
...
def export_selected_pdf_electronica():
    ...
    excel_to_pdf_electronica(temp_excel_path, pdf_path)
