document.getElementById('edit-profesor-form').addEventListener('submit', function(e) {
    ...
    // Enviar la solicitud PUT a la API de Administración
    fetch(`/administracion/administracion_profesores/${profesorId}`, {  // 🔹 Ruta actualizada para Administración
        method: 'PUT',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Autocompletado para asignaturas normales (base de datos de Administración)
    for (let i = 1; i <= 8; i++) {
        setupAsignatura(`asignatura${i}`, `horas${i}`, `asignatura-list${i}`, '/administracion/administracion_asignaturas/json');
    }

    // Autocompletado para asignaturas especiales (base de datos de Administración)
    for (let i = 1; i <= 8; i++) {
        setupAsignatura(`asignaturaE${i}`, `horasE${i}`, `asignaturaE-list${i}`, '/administracion/administracion_asignaturasE/json');
    }
});
...
document.addEventListener("DOMContentLoaded", function() {
    // LISTA DE GRUPOS PARA ADMINISTRACIÓN (Comienzan con 9)
    const gruposAdministracion = ["", "NG", "9101", "9102", "9151", "9152", "9201", "9202", "9251", "9252",
        "9301", "9302", "9351", "9352", "9401", "9402", "9451", "9452", "9501",
        "9502", "9551", "9552", "9601", "9602", "9651", "9652", "9701", "9702",
        "9751", "9752", "9801", "9802", "9851", "9852", "9901", "9902"
    ];
...
const carrerasAdministracion = ["", "ADMINISTRACIÓN", "GESTIÓN EMPRESARIAL", "CONTADURÍA", "TURISMO", "MERCADOTECNIA"];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carreraSelects.forEach(select => populateCareerSelectOptions(select, carrerasAdministracion));
});

/// **VALIDACIÓN DE HORAS ASIGNADAS - ADMINISTRACIÓN**
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    grupoSelects.forEach((select, index) => {
        ...
        // Mostrar el select de días si el grupo termina en "91" (correspondiente a Administración)
