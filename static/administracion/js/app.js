// AGREGAR PROFESORES - ADMINISTRACIÓN
document.getElementById('add-profesor-form').addEventListener('submit', function(e) {
    ...
    fetch('/administracion/administracion_profesores', {  // Ruta actualizada para Administración
        method: 'POST',
        headers: {
...
// AGREGAR ASIGNATURAS - ADMINISTRACIÓN
document.getElementById('add-asignatura-form').addEventListener('submit', function(e) {
    ...
    fetch('/administracion/administracion_asignaturas', {  // Ruta actualizada para Administración
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
// AGREGAR ASIGNATURAS ESPECIALES - ADMINISTRACIÓN
document.getElementById('add-asignaturaE-form').addEventListener('submit', function(e) {
    ...
    fetch('/administracion/administracion_asignaturasE', {  // Ruta actualizada para Administración
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturas_administracion'
    setupAsignatura('asignatura1', 'horas1', 'asignatura-list1', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura2', 'horas2', 'asignatura-list2', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura3', 'horas3', 'asignatura-list3', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura4', 'horas4', 'asignatura-list4', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura5', 'horas5', 'asignatura-list5', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura6', 'horas6', 'asignatura-list6', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura7', 'horas7', 'asignatura-list7', '/administracion/administracion_asignaturas/json');
    setupAsignatura('asignatura8', 'horas8', 'asignatura-list8', '/administracion/administracion_asignaturas/json');

    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturasE_administracion'
    setupAsignatura('asignaturaE1', 'horasE1', 'asignaturaE-list1', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE2', 'horasE2', 'asignaturaE-list2', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE3', 'horasE3', 'asignaturaE-list3', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE4', 'horasE4', 'asignaturaE-list4', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE5', 'horasE5', 'asignaturaE-list5', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE6', 'horasE6', 'asignaturaE-list6', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE7', 'horasE7', 'asignaturaE-list7', '/administracion/administracion_asignaturasE/json');
    setupAsignatura('asignaturaE8', 'horasE8', 'asignaturaE-list8', '/administracion/administracion_asignaturasE/json');
...
// ELIMINAR PROFESOR - ADMINISTRACIÓN
function deleteProfesor(id) {
    if (confirm('¿Estás seguro de que deseas eliminar este profesor?')) {
        fetch(`/administracion/administracion_profesores/${id}`, {  // Se cambia la ruta a administracion_profesores
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
...
// ELIMINAR ASIGNATURA - ADMINISTRACIÓN
function deleteAsignatura(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura?')) {
        fetch(`/administracion/administracion_asignaturas/${id}`, {  // Se cambia la ruta a administracion_asignaturas
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ELIMINAR ASIGNATURA ESPECIAL - ADMINISTRACIÓN
function deleteAsignaturaE(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura especial?')) {
        fetch(`/administracion/administracion_asignaturasE/${id}`, {  // Se cambia la ruta a administracion_asignaturasE
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ACTUALIZAR ASIGNATURA EN ADMINISTRACIÓN
document.addEventListener('DOMContentLoaded', function() {
    ...
    editForm.addEventListener('submit', function(event) {
        ...
        fetch(`/administracion/administracion_asignaturas/${asignaturaId}`, {  // Se cambia la ruta a administracion_asignaturas
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
...
// CALCULAR TOTAL DE HORAS EN ADMINISTRACIÓN
...
// JavaScript para mostrar/ocultar el formulario en ADMINISTRACIÓN
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mostrar/ocultar formulario de asignaturas en ADMINISTRACIÓN
    ...
    // Mostrar/ocultar formulario de asignaturas especiales en ADMINISTRACIÓN
...
// GRUPOS PARA ADMINISTRACIÓN
const gruposAdministracion = ["", "NG", "9101", "9102", "9151", "9152", "9201", "9202", "9251", "9252",
    "9301", "9302", "9351", "9352", "9401", "9402", "9451", "9452", "9501", "9502", "9551", "9552", 
    "9601", "9602", "9651", "9652", "9751", "9752", "9851", "9852", "9951", "9952"
];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Poblar cada select con las opciones de grupos de Administración
    gruposSelects.forEach(select => populateSelectOptions(select, gruposAdministracion));
    ...
    inputGroups.forEach(group => {
        ...
        customInput.addEventListener("input", function() {
            ...
            if (gruposAdministracion.includes(value)) {
...
// LISTA DE CARRERAS PARA ADMINISTRACIÓN
const carrerasAdministracion = ["", "ADMINISTRACIÓN", "SISTEMAS COMPUTACIONALES", "INDUSTRIAL", "INFORMÁTICA", "ELECTRÓNICA", "ELECTROMECÁNICA"];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carreraESelects.forEach(select => {
        select.innerHTML = carrerasAdministracion.map(carrera => `<option value="${carrera}">${carrera}</option>`).join("");
    });
...
// MANEJO DE HORAS DE TRANSMISIÓN PARA GRUPOS 91 EN ADMINISTRACIÓN
document.addEventListener("DOMContentLoaded", function() {
    ...
    grupoSelects.forEach((select, index) => {
        select.addEventListener("change", function() {
            ...
            // Si el grupo seleccionado termina en "91", activar la selección de día
            if (grupoValue.endsWith("91")) {
