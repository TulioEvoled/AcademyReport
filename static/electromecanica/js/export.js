...
document.getElementById('load-professors').addEventListener('click', function() {
    fetch('/electromecanica/electromecanica_profesores/json')
...
document.getElementById('uploadImagesForm').addEventListener('submit', function(event) {
    ...
    fetch('/electromecanica/electromecanica_upload-images', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('updateTextForm').addEventListener('submit', function(event) {
    ...
    fetch('/electromecanica/electromecanica_update-text', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('updateTextFormDos').addEventListener('submit', function(event) {
    ...
    fetch('/electromecanica/electromecanica_update-text-a54', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('export-form').addEventListener('submit', function(e) {
    ...
    fetch('/electromecanica/electromecanica_export', {  // 🔹 Ruta actualizada para Electromecánica
            method: 'POST',
            headers: {
...
document.getElementById('collection').addEventListener('change', function() {
    ...
    fetch(`/electromecanica/electromecanica_columns/${collection}`) // 🔹 Ruta actualizada para Electromecánica
        .then(response => response.json())
        .then(columns => {
