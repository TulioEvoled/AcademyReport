...
document.getElementById('load-professors').addEventListener('click', function() {
    fetch('/electronica/electronica_profesores/json')
...
document.getElementById('uploadImagesForm').addEventListener('submit', function(event) {
    ...
    fetch('/electronica/electronica_upload-images', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('updateTextForm').addEventListener('submit', function(event) {
    ...
    fetch('/electronica/electronica_update-text', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('updateTextFormDos').addEventListener('submit', function(event) {
    ...
    fetch('/electronica/electronica_update-text-a54', {
            method: 'POST',
            body: formData
        })
        .then(response => response.json())
...
document.getElementById('export-form').addEventListener('submit', function(e) {
    ...
    fetch('/electronica/electronica_export', {  // Se cambia la ruta a electrónica
            method: 'POST',
            headers: {
...
document.getElementById('collection').addEventListener('change', function() {
    ...
    fetch(`/electronica/electronica_columns/${collection}`) // Se cambia la ruta a electrónica
        .then(response => response.json())
        .then(columns => {
