...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturas_electronica'
    setupAsignatura('asignatura1', 'horas1', 'asignatura-list1', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura2', 'horas2', 'asignatura-list2', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura3', 'horas3', 'asignatura-list3', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura4', 'horas4', 'asignatura-list4', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura5', 'horas5', 'asignatura-list5', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura6', 'horas6', 'asignatura-list6', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura7', 'horas7', 'asignatura-list7', '/electronica/electronica_asignaturas/json');
    setupAsignatura('asignatura8', 'horas8', 'asignatura-list8', '/electronica/electronica_asignaturas/json');

    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturasE_electronica'
    setupAsignatura('asignaturaE1', 'horasE1', 'asignaturaE-list1', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE2', 'horasE2', 'asignaturaE-list2', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE3', 'horasE3', 'asignaturaE-list3', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE4', 'horasE4', 'asignaturaE-list4', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE5', 'horasE5', 'asignaturaE-list5', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE6', 'horasE6', 'asignaturaE-list6', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE7', 'horasE7', 'asignaturaE-list7', '/electronica/electronica_asignaturasE/json');
    setupAsignatura('asignaturaE8', 'horasE8', 'asignaturaE-list8', '/electronica/electronica_asignaturasE/json');
...
// GRUPOS PARA ELECTRÓNICA
const gruposElectronica = ["", "NG", "3101", "3102", "3151", "3152", "3201", "3202", "3251", "3252",
    "3301", "3302", "3351", "3352", "3401", "3402", "3451", "3452", "3501", "3502", "3551", "3552", 
    "3601", "3602", "3651", "3652", "3751", "3752", "3851", "3852", "3951", "3952"
];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Poblar cada select con las opciones de grupos de electrónica
    gruposSelects.forEach(select => populateSelectOptions(select, gruposElectronica));
