document.getElementById('edit-profesor-form').addEventListener('submit', function(e) {
    ...
    // Enviar la solicitud PUT a la API de Informática
    fetch(`/informatica/informatica_profesores/${profesorId}`, {
        method: 'PUT',
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Autocompletado para asignaturas normales (base de datos de informática)
    for (let i = 1; i <= 8; i++) {
        setupAsignatura(`asignatura${i}`, `horas${i}`, `asignatura-list${i}`, '/informatica/informatica_asignaturas/json');
    }

    // Autocompletado para asignaturas especiales (base de datos de informática)
    for (let i = 1; i <= 8; i++) {
        setupAsignatura(`asignaturaE${i}`, `horasE${i}`, `asignaturaE-list${i}`, '/informatica/informatica_asignaturasE/json');
    }
...
document.addEventListener("DOMContentLoaded", function() {
    // LISTA DE GRUPOS PARA INFORMÁTICA (Comienzan con 6)
    const gruposInformatica = ["", "NG", "6101", "6102", "6151", "6152", "6201", "6202", "6251", "6252",
        "6301", "6302", "6351", "6352", "6401", "6402", "6451", "6452", "6501",
        "6502", "6551", "6552", "6601", "6602", "6651", "6652", "6701", "6702",
        "6751", "6752", "6801", "6802", "6851", "6852", "6901", "6902"
    ];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carreraSelects.forEach(select => populateCareerSelectOptions(select, carrerasInformatica));
});

/// **VALIDACIÓN DE HORAS ASIGNADAS - INFORMÁTICA**
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    grupoSelects.forEach((select, index) => {
        ...
        // Mostrar el select de días si el grupo termina en "61" (correspondiente a Informática)
        function actualizarSelector() {
            const grupoValue = select.value.trim();
            if (grupoValue.endsWith("61")) { 
