// AGREGAR PROFESORES - INFORMÁTICA
document.getElementById('add-profesor-form').addEventListener('submit', function(e) {
    ...
    fetch('/informatica/informatica_profesores', {  // Ruta actualizada para Informática
        method: 'POST',
        headers: {
...
// AGREGAR ASIGNATURAS - INFORMÁTICA
document.getElementById('add-asignatura-form').addEventListener('submit', function(e) {
    ...
    fetch('/informatica/informatica_asignaturas', {  // Ruta actualizada para Informática
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
// AGREGAR ASIGNATURAS ESPECIALES - INFORMÁTICA
document.getElementById('add-asignaturaE-form').addEventListener('submit', function(e) {
    ...
    fetch('/informatica/informatica_asignaturasE', {  // Ruta actualizada para Informática
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturas_informatica'
    setupAsignatura('asignatura1', 'horas1', 'asignatura-list1', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura2', 'horas2', 'asignatura-list2', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura3', 'horas3', 'asignatura-list3', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura4', 'horas4', 'asignatura-list4', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura5', 'horas5', 'asignatura-list5', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura6', 'horas6', 'asignatura-list6', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura7', 'horas7', 'asignatura-list7', '/informatica/informatica_asignaturas/json');
    setupAsignatura('asignatura8', 'horas8', 'asignatura-list8', '/informatica/informatica_asignaturas/json');

    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturasE_informatica'
    setupAsignatura('asignaturaE1', 'horasE1', 'asignaturaE-list1', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE2', 'horasE2', 'asignaturaE-list2', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE3', 'horasE3', 'asignaturaE-list3', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE4', 'horasE4', 'asignaturaE-list4', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE5', 'horasE5', 'asignaturaE-list5', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE6', 'horasE6', 'asignaturaE-list6', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE7', 'horasE7', 'asignaturaE-list7', '/informatica/informatica_asignaturasE/json');
    setupAsignatura('asignaturaE8', 'horasE8', 'asignaturaE-list8', '/informatica/informatica_asignaturasE/json');
...
// ELIMINAR PROFESOR - INFORMÁTICA
function deleteProfesor(id) {
    if (confirm('¿Estás seguro de que deseas eliminar este profesor?')) {
        fetch(`/informatica/informatica_profesores/${id}`, {  // Se cambia la ruta a informatica_profesores
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
...
// ELIMINAR ASIGNATURA - INFORMÁTICA
function deleteAsignatura(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura?')) {
        fetch(`/informatica/informatica_asignaturas/${id}`, {  // Se cambia la ruta a informatica_asignaturas
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ELIMINAR ASIGNATURA ESPECIAL - INFORMÁTICA
function deleteAsignaturaE(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura especial?')) {
        fetch(`/informatica/informatica_asignaturasE/${id}`, {  // Se cambia la ruta a informatica_asignaturasE
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ACTUALIZAR ASIGNATURA EN INFORMÁTICA
document.addEventListener('DOMContentLoaded', function() {
    ...
    editForm.addEventListener('submit', function(event) {
        ...
        fetch(`/informatica/informatica_asignaturas/${asignaturaId}`, {  // Se cambia la ruta a informatica_asignaturas
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
...
// CALCULAR TOTAL DE HORAS EN INFORMÁTICA
...
// JavaScript para mostrar/ocultar el formulario en INFORMÁTICA
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mostrar/ocultar formulario de asignaturas en INFORMÁTICA
    ...
    // Mostrar/ocultar formulario de asignaturas especiales en INFORMÁTICA
...
// GRUPOS PARA INFORMÁTICA
const gruposInformatica = ["", "NG", "6101", "6102", "6151", "6152", "6201", "6202", "6251", "6252",
    "6301", "6302", "6351", "6352", "6401", "6402", "6451", "6452", "6501", "6502", "6551", "6552", 
    "6601", "6602", "6651", "6652", "6751", "6752", "6851", "6852", "6951", "6952"
];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Poblar cada select con las opciones de grupos de informática
    gruposSelects.forEach(select => populateSelectOptions(select, gruposInformatica));
    ...
    inputGroups.forEach(group => {
        ...
        customInput.addEventListener("input", function() {
            ...
            if (gruposInformatica.includes(value)) {
...
// LISTA DE CARRERAS PARA INFORMÁTICA
const carrerasInformatica = ["", "INFORMÁTICA", "SISTEMAS COMPUTACIONALES", "INDUSTRIAL", "ELECTRÓNICA", "ELECTROMECÁNICA", "ADMINISTRACIÓN"];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carreraESelects.forEach(select => {
        select.innerHTML = carrerasInformatica.map(carrera => `<option value="${carrera}">${carrera}</option>`).join("");
    });
...
// MANEJO DE HORAS DE TRANSMISIÓN PARA GRUPOS 71 EN INFORMÁTICA
document.addEventListener("DOMContentLoaded", function() {
