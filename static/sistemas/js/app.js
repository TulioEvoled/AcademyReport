// AGREGAR PROFESORES - SISTEMAS COMPUTACIONALES
document.getElementById('add-profesor-form').addEventListener('submit', function(e) {
    ...
    fetch('/sistemas/sistemas_profesores', {  // Se cambia la URL a la de sistemas
        method: 'POST',
        headers: {
...
// AGREGAR ASIGNATURAS - SISTEMAS COMPUTACIONALES
document.getElementById('add-asignatura-form').addEventListener('submit', function(e) {
    ...
    fetch('/sistemas/sistemas_asignaturas', {  // Se cambia la URL a la de sistemas
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
// AGREGAR ASIGNATURAS ESPECIALES - SISTEMAS COMPUTACIONALES
document.getElementById('add-asignaturaE-form').addEventListener('submit', function(e) {
    ...
    fetch('/sistemas/sistemas_asignaturasE', {  // Se cambia la URL a la de sistemas
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturas_sistemas'
    setupAsignatura('asignatura1', 'horas1', 'asignatura-list1', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura2', 'horas2', 'asignatura-list2', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura3', 'horas3', 'asignatura-list3', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura4', 'horas4', 'asignatura-list4', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura5', 'horas5', 'asignatura-list5', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura6', 'horas6', 'asignatura-list6', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura7', 'horas7', 'asignatura-list7', '/sistemas/sistemas_asignaturas/json');
    setupAsignatura('asignatura8', 'horas8', 'asignatura-list8', '/sistemas/sistemas_asignaturas/json');

    // Configurar autocompletado y horas para asignaturas desde la tabla 'asignaturasE_sistemas'
    setupAsignatura('asignaturaE1', 'horasE1', 'asignaturaE-list1', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE2', 'horasE2', 'asignaturaE-list2', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE3', 'horasE3', 'asignaturaE-list3', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE4', 'horasE4', 'asignaturaE-list4', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE5', 'horasE5', 'asignaturaE-list5', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE6', 'horasE6', 'asignaturaE-list6', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE7', 'horasE7', 'asignaturaE-list7', '/sistemas/sistemas_asignaturasE/json');
    setupAsignatura('asignaturaE8', 'horasE8', 'asignaturaE-list8', '/sistemas/sistemas_asignaturasE/json');
...
function deleteProfesor(id) {
    if (confirm('¿Estás seguro de que deseas eliminar este profesor?')) {
        fetch(`/sistemas/sistemas_profesores/${id}`, {  // Se cambia la ruta a sistemas_profesores
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
...
function deleteAsignatura(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura?')) {
        fetch(`/sistemas/sistemas_asignaturas/${id}`, {  // Se cambia la ruta a sistemas_asignaturas
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ELIMINAR ASIGNATURA ESPECIAL
function deleteAsignaturaE(id) {
    if (confirm('¿Estás seguro de que deseas eliminar esta asignatura especial?')) {
        fetch(`/sistemas/sistemas_asignaturasE/${id}`, {  // Se cambia la ruta a sistemas_asignaturasE
            method: 'DELETE'
        }).then(response => {
            if (response.ok) {
                window.location.reload();
...
// ACTUALIZAR ASIGNATURA EN SISTEMAS COMPUTACIONALES
document.addEventListener('DOMContentLoaded', function() {
    ...
    editForm.addEventListener('submit', function(event) {
        ...
        fetch(`/sistemas/sistemas_asignaturas/${asignaturaId}`, {  // Se cambia la ruta a sistemas_asignaturas
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json'
                },
...
// CALCULAR TOTAL DE HORAS EN SISTEMAS COMPUTACIONALES
...
// JavaScript para mostrar/ocultar el formulario en SISTEMAS COMPUTACIONALES
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mostrar/ocultar formulario de asignaturas en SISTEMAS
    ...
    // Mostrar/ocultar formulario de asignaturas especiales en SISTEMAS
...
/// HORARIOS PARA SISTEMAS COMPUTACIONALES
...
// GRUPOS PARA SISTEMAS COMPUTACIONALES
const gruposSistemas = ["", "NG", "4101", "4102", "4151", "4152", "4171", "4201", "4202", "4251", "4252",
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    // Poblar cada select con las opciones de grupos de sistemas
    gruposSelects.forEach(select => populateSelectOptions(select, gruposSistemas));
    ...
    inputGroups.forEach(group => {
        ...
        customInput.addEventListener("input", function() {
            ...
            if (gruposSistemas.includes(value)) {
...
const carrerasSistemas = ["", "SISTEMAS COMPUTACIONALES", "INDUSTRIAL", "ELECTRÓNICA", "ELECTROMECÁNICA", "INFORMÁTICA", "ADMINISTRACIÓN"];
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    carreraESelects.forEach(select => {
        select.innerHTML = carrerasSistemas.map(carrera => `<option value="${carrera}">${carrera}</option>`).join("");
    });
...
// MANEJO DE HORAS DE TRANSMISIÓN PARA GRUPOS 81 EN SISTEMAS COMPUTACIONALES
document.addEventListener("DOMContentLoaded", function() {
    ...
    grupoSelects.forEach((select, index) => {
        select.addEventListener("change", function() {
            ...
            // Si el grupo seleccionado termina en "81", activar la selección de día
